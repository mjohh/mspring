...
int aps_controller_init(struct aps_controller *aps, int (*output_set_kbyte) (int ringid, int cardid, int portid, struct k1k2 * k1k2), int (*output_update_hw) (int ringid, int cardid[], int portid[], enum node_state state), int (*output_start_wtr) (int ringid, int enable, int sec))
{
