...
{
    return RMAX(get_highest_brq_on_side(aps, WEST), 
		         get_highest_brq_on_side(aps, EAST));
}
...
int is_valid_long_reply_for_brq(struct aps_controller* aps, 
									 enum brq_code brq, enum side reply_side)
{
